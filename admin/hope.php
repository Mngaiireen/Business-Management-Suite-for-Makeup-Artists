...
for($i=0;$i<count($sid);$i++){
   $svid=$sid[$i];
$AppointmentID=intval($_GET['viewid']);
   

$ret=mysqli_query($con,"insert into tblinvoice(Userid,AppointmentID,ServiceId,BillingId) values('$uid',$AppointmentID,'$svid','$invoiceid');");
...
<html>
<head>
<title>Divine || Service provided</title>
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Service provided</h3>
