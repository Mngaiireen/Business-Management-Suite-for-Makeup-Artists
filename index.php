	      ...
	      <div class="slider-item js-fullheight">
	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
	          	<img class="one-third align-self-end order-md-last img-fluid" src="images/siz.jpg" alt="">
	      ...
	      <div class="slider-item js-fullheight">
	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
	          	<img class="one-third align-self-end order-md-last img-fluid" src="images/ireen.jpeg" alt="">
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text mt-5">
		          		<span class="subheading">Natural Beauty</span>
			            <h1 class="mb-4">Beauty parlour</h1>
    				...
    				<div class="text">
    					...
    					<div class="appointment-wrap">
    						<span class="subheading">Reservation</span>
								<h3 class="mb-2">Book a Service</h3>
              ...
              ?>
			              ...
			              <div class="col-sm-12">
			                <div class="form-group service-input">
			                  <input type="date" class="form-control" placeholder="Date" name="adate" id='adate' required="true"
							  min="<?php echo date('Y-m-d'); ?>">
			                </div>    
			              </div>
			              <div class="col-sm-12">
			                <div class="form-group service-input">
			                  <input type="time" class="form-control" placeholder="Time" name="atime" id='atime' required="true">
			                </div>
			              </div>
			              <div class="col-sm-12">
			                <div class="form-group">
					...
					<div class="one-third">
						...
						<div class="calendly-inline-widget" data-url="https://calendly.com/ireenhope/virtual-consultations" style="min-width:320px;height:400px;"></div>
						</div>
						</div>
					</div>
