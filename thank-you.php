    ...
    <section class="ftco-section ftco-no-pb">
    	<div class="container">
          ...
          <div class="col-md-6 text-center heading-section ftco-animate">
          	<h4 class="w3ls_head">Thank you for applying. we will contact you on the same.Your Booking number is <?php echo $_SESSION['aptno'];?> </h4>
        </div>
    	</div>
